...
export async function getLLMResponse(config: LlmConfig, userMessage: string): Promise<string> {
  return llmService.sendMessage(config, userMessage) as Promise<string>
}
